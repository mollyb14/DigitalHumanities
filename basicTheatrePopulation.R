...
plot(dataMeaning$theatres,dataMeaning$people,type="n",xlab="number of theatres",ylab="number of people")
...
myModel = lm(dataMeaning$population~dataMeaning$theatres)
summary(myModel)
...
newMeanings = jitter(dataMeaning$population, 5)
